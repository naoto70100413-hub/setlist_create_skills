...
いずれかのルール（掛け持ち間隔・曲アーティストの連続・希望時間帯など）を守れなかったチームは、出力Excelの**備考欄**にその理由を記載し、行を黄色背景で強調する。
...
- **備考**: 掛け持ち間隔不足・曲/アーティストの連続・希望時間帯未達などルール違反があるチームにのみ理由を記載（複数ある場合は`; `区切り）。何も違反がなければ空欄。
