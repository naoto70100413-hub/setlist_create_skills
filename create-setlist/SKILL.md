...
|---|---|---|---|---|---|---|---|---|---|
| 1 | 1-1 | 13:00:00 | TEAM_A | ... | ... | 3:45 | 0:30 | TEAM_C | 掛け持ち間隔不足: TEAM_Cとの間隔が0:25:00（目安:1時間、最低:40分） |
| 2 | 1-2 | 13:04:15 | TEAM_B | ... | ... | 4:12 | 0:30 | | 掛け持ち間隔が目安未達: TEAM_Dとの間隔が0:50:00（最低40分は確保、目安1時間には未達） |
| 出演順 | ブロック内番号 | 出演開始時間 | チーム名 | 曲名 | アーティスト名 | 出演時間 | 入りはけ時間 | 掛け持ちチーム... | 備考 |
| 3 | 2-1 | 13:30:00 | TEAM_C | ... | ... | 3:20 | 0:30 | TEAM_A | 掛け持ち間隔不足: TEAM_Aとの間隔が0:25:00（目安:1時間、最低:40分） |

- **備考**: 文句なしにクリアしていない項目がある場合、その理由を全て記載する（複数ある場合は`; `区切り）。全項目を完全に満たしている場合のみ空欄。
